...
namespace AccelByte.Sdk.Api.Ams.Operation
{
    ...
    public class InfoSupportedInstances : AccelByte.Sdk.Core.Operation
    {
        ...
        public Model.ApiInstanceTypesResponse? ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            else if (code == (HttpStatusCode)201)
            {
                if (ResponseJsonOptions != null)
                    return JsonSerializer.Deserialize<Model.ApiInstanceTypesResponse>(payload, ResponseJsonOptions);
                else
                    return JsonSerializer.Deserialize<Model.ApiInstanceTypesResponse>(payload);
            }
