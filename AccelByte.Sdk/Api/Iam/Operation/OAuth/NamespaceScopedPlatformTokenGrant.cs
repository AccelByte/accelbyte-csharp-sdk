...
namespace AccelByte.Sdk.Api.Iam.Operation
{
    ...
    public class NamespaceScopedPlatformTokenGrant : AccelByte.Sdk.Core.Operation
    {
        #region Builder Part
        public static NamespaceScopedPlatformTokenGrantBuilder Builder { get => new NamespaceScopedPlatformTokenGrantBuilder(); }

        public class NamespaceScopedPlatformTokenGrantBuilder
            : OperationBuilder<NamespaceScopedPlatformTokenGrantBuilder>
        {
            ...
            internal NamespaceScopedPlatformTokenGrantBuilder() { }




            public NamespaceScopedPlatformTokenGrantBuilder SetDeviceId(string _deviceId)
            {
                DeviceId = _deviceId;
                return this;
            }

            public NamespaceScopedPlatformTokenGrantBuilder SetMacAddress(string _macAddress)
            {
                MacAddress = _macAddress;
                return this;
            }

            public NamespaceScopedPlatformTokenGrantBuilder SetPlatformToken(string _platformToken)
            {
            ...
            public NamespaceScopedPlatformTokenGrant Build(
                string namespace_,
                string platformId
            )
            {
                NamespaceScopedPlatformTokenGrant op = new NamespaceScopedPlatformTokenGrant(this,
                    namespace_,
                    platformId
                );
        ...
        private NamespaceScopedPlatformTokenGrant(NamespaceScopedPlatformTokenGrantBuilder builder,
            string namespace_,
            string platformId
        )
        {
