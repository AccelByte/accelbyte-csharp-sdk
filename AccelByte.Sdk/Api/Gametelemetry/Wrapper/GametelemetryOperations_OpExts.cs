...
namespace AccelByte.Sdk.Api
{
    public static class GametelemetryGametelemetryOperations_OpExts
    {
        ...
        )
        {
            ...
            await ((Gametelemetry.Wrapper.GametelemetryOperations)builder.WrapperObject!).ProtectedSaveEventsGameTelemetryV1ProtectedEventsPostAsync(op);
        }
        ...
        public static async Task<Gametelemetry.Model.PlayTimeResponse?> ExecuteAsync(
            this ProtectedGetPlaytimeGameTelemetryV1ProtectedSteamIdsSteamIdPlaytimeGet.ProtectedGetPlaytimeGameTelemetryV1ProtectedSteamIdsSteamIdPlaytimeGetBuilder builder,
            string steamId
        ...
        )
        {
            ...
            return await ((Gametelemetry.Wrapper.GametelemetryOperations)builder.WrapperObject!).ProtectedGetPlaytimeGameTelemetryV1ProtectedSteamIdsSteamIdPlaytimeGetAsync(op);
        }
        public static Gametelemetry.Model.PlayTimeResponse? Execute(
        ...
        )
        {
            ...
            return await ((Gametelemetry.Wrapper.GametelemetryOperations)builder.WrapperObject!).ProtectedUpdatePlaytimeGameTelemetryV1ProtectedSteamIdsSteamIdPlaytimePlaytimePutAsync(op);
        }
    }
}