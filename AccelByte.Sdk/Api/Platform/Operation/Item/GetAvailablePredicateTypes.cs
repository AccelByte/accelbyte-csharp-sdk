...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    {
        #region Builder Part
        public static GetAvailablePredicateTypesBuilder Builder = new GetAvailablePredicateTypesBuilder();
        ...
        public List<Model.AvailablePredicateObject>? ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {            
            ...
            {
                return JsonSerializer.Deserialize<List<Model.AvailablePredicateObject>>(payload);
            }
