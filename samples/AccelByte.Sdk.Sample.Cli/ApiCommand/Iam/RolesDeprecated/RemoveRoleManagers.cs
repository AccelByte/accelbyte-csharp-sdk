...
{
    [SdkConsoleCommand("iam","deprecated-removerolemanagers")]
    public class DeprecatedRemoveRoleManagersCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedRemoveRoleManagersCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
