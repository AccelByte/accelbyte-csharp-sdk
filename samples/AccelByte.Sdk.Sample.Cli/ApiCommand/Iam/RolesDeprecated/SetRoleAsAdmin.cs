...
{
    [SdkConsoleCommand("iam","deprecated-setroleasadmin")]
    public class DeprecatedSetRoleAsAdminCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedSetRoleAsAdminCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
