...
{
    [SdkConsoleCommand("iam","deprecated-addrolepermission")]
    public class DeprecatedAddRolePermissionCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedAddRolePermissionCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
