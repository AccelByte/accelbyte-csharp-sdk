...
{
    [SdkConsoleCommand("iam","deprecated-getrolemembers")]
    public class DeprecatedGetRoleMembersCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedGetRoleMembersCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
