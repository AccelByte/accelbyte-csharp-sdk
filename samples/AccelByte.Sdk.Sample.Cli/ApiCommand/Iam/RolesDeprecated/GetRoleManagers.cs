...
{
    [SdkConsoleCommand("iam","deprecated-getrolemanagers")]
    public class DeprecatedGetRoleManagersCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedGetRoleManagersCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
