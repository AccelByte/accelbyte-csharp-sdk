...
{
    [SdkConsoleCommand("iam","deprecated-addrolemanagers")]
    public class DeprecatedAddRoleManagersCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedAddRoleManagersCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
