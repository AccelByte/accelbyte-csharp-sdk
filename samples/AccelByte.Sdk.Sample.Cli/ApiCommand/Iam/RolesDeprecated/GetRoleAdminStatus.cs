...
{
    [SdkConsoleCommand("iam","deprecated-getroleadminstatus")]
    public class DeprecatedGetRoleAdminStatusCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedGetRoleAdminStatusCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
