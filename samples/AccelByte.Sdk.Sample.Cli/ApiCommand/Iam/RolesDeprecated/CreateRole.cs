...
{
    [SdkConsoleCommand("iam","deprecated-createrole")]
    public class DeprecatedCreateRoleCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedCreateRoleCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
