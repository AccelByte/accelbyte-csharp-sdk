...
{
    [SdkConsoleCommand("iam","deprecated-deleterolepermission")]
    public class DeprecatedDeleteRolePermissionCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedDeleteRolePermissionCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
