...
{
    [SdkConsoleCommand("iam","deprecated-updaterole")]
    public class DeprecatedUpdateRoleCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedUpdateRoleCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
