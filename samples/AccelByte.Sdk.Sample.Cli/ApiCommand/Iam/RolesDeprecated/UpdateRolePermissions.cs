...
{
    [SdkConsoleCommand("iam","deprecated-updaterolepermissions")]
    public class DeprecatedUpdateRolePermissionsCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedUpdateRolePermissionsCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
