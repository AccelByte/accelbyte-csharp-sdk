...
{
    [SdkConsoleCommand("iam","deprecated-addclientpermission")]
    public class DeprecatedAddClientPermissionCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedAddClientPermissionCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
