...
{
    [SdkConsoleCommand("iam","deprecated-createclient")]
    public class DeprecatedCreateClientCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedCreateClientCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
