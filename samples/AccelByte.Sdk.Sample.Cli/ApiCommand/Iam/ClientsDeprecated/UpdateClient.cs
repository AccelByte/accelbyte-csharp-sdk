...
{
    [SdkConsoleCommand("iam","deprecated-updateclient")]
    public class DeprecatedUpdateClientCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedUpdateClientCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
