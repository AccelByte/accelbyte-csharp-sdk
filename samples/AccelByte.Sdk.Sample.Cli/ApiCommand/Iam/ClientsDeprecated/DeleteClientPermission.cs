...
{
    [SdkConsoleCommand("iam","deprecated-deleteclientpermission")]
    public class DeprecatedDeleteClientPermissionCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedDeleteClientPermissionCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
