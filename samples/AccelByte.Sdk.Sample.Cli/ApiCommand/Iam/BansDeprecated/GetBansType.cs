...
{
    [SdkConsoleCommand("iam","deprecated-getbanstype")]
    public class DeprecatedGetBansTypeCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedGetBansTypeCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
