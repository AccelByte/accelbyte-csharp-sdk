...
{
    [SdkConsoleCommand("platform","deprecated-getuserwallet")]
    public class DeprecatedGetUserWalletCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedGetUserWalletCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
