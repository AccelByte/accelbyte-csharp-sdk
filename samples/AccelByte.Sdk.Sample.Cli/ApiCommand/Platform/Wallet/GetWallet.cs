...
{
    [SdkConsoleCommand("platform","deprecated-getwallet")]
    public class DeprecatedGetWalletCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedGetWalletCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
