...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class BulkFulfillItemsV3Command : ISdkConsoleCommand
    {
        ...
        public BulkFulfillItemsV3Command(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            List<AccelByte.Sdk.Api.Platform.Model.FulfillmentV2Result>? response = wrapper.BulkFulfillItemsV3(operation);
            if (response == null)
