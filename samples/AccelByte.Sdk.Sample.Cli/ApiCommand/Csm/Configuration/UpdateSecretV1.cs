...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Csm
{
    ...
    public class UpdateSecretV1Command: ISdkConsoleCommand
    {
        ...
        public UpdateSecretV1Command(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            AccelByte.Sdk.Api.Csm.Model.GeneratedUpdateConfigurationV1Response? response = wrapper.UpdateSecretV1(operation);
            if (response == null)
