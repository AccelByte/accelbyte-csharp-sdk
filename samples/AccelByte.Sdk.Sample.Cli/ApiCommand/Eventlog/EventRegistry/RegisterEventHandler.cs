...
{
    [SdkConsoleCommand("eventlog","deprecated-registereventhandler")]
    public class DeprecatedRegisterEventHandlerCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedRegisterEventHandlerCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
