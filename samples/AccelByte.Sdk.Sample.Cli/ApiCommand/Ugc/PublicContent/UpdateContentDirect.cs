...
{
    [SdkConsoleCommand("ugc","deprecated-updatecontentdirect")]
    public class DeprecatedUpdateContentDirectCommand: ISdkConsoleCommand
    {
        ...
        public DeprecatedUpdateContentDirectCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
