...
$CLI_EXE \
    ...
    --limit '70' \
    --offset '52' \
    --sortBy '["createdAt:desc", "displayOrder:desc", "updatedAt"]' \
...
#- 273 BulkCredit
# body param: body
echo '[{"creditRequest": {"amount": 78, "expireAt": "1980-04-19T00:00:00Z", "origin": "Other", "reason": "JHfYOIq0fn3exKzz", "source": "SELL_BACK"}, "currencyCode": "osIKaLWXX9sJ4E3b", "userIds": ["iG949htoGBSpZpQW", "f3hHMnUEihhthApz", "PpG0YIceHTzjSteS"]}, {"creditRequest": {"amount": 83, "expireAt": "1994-03-21T00:00:00Z", "origin": "Playstation", "reason": "LDIjMxbQtjTjWnlE", "source": "REFUND"}, "currencyCode": "ZYvi7KIlGj2Xmztt", "userIds": ["i1gLibwa5jSP4E8O", "tUuwfmhfgamQwklt", "XpDdSECY0i0UosMI"]}, {"creditRequest": {"amount": 26, "expireAt": "1971-04-19T00:00:00Z", "origin": "Playstation", "reason": "F4caHL1i0RDJT7SZ", "source": "REWARD"}, "currencyCode": "TRzIkIDWQinFKfQo", "userIds": ["nkRPN150sWbrf1db", "GHhwoce2OVaDcRNr", "K7sED8WI7OsWO31d"]}]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn platform \
    --op BulkCredit \
    --namespace $AB_NAMESPACE \
...
#- 274 BulkDebit
# body param: body
echo '[{"currencyCode": "MxTGug0tWXMZPUnD", "request": {"allowOverdraft": true, "amount": 5, "balanceOrigin": "Twitch", "reason": "9D0YQ7hpUaOWDqyc"}, "userIds": ["EJCwPbqbRkVyXpOE", "ZqEq725ddYecMzTr", "ar5qK3eB5ITFEREM"]}, {"currencyCode": "48spZQBmM16WnLhD", "request": {"allowOverdraft": false, "amount": 57, "balanceOrigin": "Other", "reason": "cQZBy7NGZumtwcCu"}, "userIds": ["kpNcAE6M0MC3pDcF", "CfyvegPF6TW4ULhK", "ii3kV1QasG8GvRva"]}, {"currencyCode": "1lNHXRbvIUl8BOQ6", "request": {"allowOverdraft": true, "amount": 36, "balanceOrigin": "Playstation", "reason": "kbK21jK0suo8Fcgz"}, "userIds": ["soAZ7AA6Erj3Y1wb", "383dwxZh1yxpCANq", "EJHNHKjsgEhovmUj"]}]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn platform \
    --op BulkDebit \
    --namespace $AB_NAMESPACE \
...
$CLI_EXE \
    ...
    --sortBy '["name:desc", "updatedAt:asc", "displayOrder:asc"]' \
...
$CLI_EXE \
    ...
    --sortBy '["createdAt:desc", "name", "createdAt"]' \
