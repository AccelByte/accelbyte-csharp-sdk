...
# body param: body
echo '["LbZ0VBUG", "A7nkDeev", "2Oj060Hn"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
# body param: body
echo '["Of5S8X1L", "xkZs4233", "oQWoXFeq"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
$CLI_EXE \
    ...
    --namespace $AB_NAMESPACE \
    --emails '["euI2oMJ0", "cgAoGfXe", "pE3r5AQU"]' \
    > test.out 2>&1
