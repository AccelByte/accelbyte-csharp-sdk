...
# body param: body
echo '["df5AhmNT", "LgKu4tzG", "jDcNnTqA"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
# body param: body
echo '["uxj19tvi", "aqfo3rwq", "RhUlfSoP"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
$CLI_EXE \
    ...
    --namespace $AB_NAMESPACE \
    --emails '["MDwPoCAL", "Um5s5o2g", "vinHN9vV"]' \
    > test.out 2>&1
