...
# body param: body
echo '["yylE4Db3", "0bhnDnga", "OJ6ciasi"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
# body param: body
echo '["NXLmf5tw", "jwEytfYy", "0I5ZnxVv"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
$CLI_EXE \
    ...
    --namespace $AB_NAMESPACE \
    --emails '["Tx3Jt62z", "exLpE6tc", "dkwtuEIv"]' \
    > test.out 2>&1
