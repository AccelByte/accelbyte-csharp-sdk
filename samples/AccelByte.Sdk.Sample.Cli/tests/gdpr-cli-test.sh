...
# body param: body
echo '["CbWQYZ36", "wB3oYePu", "n8dM9mie"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
# body param: body
echo '["wht11SeL", "AZLVjtAj", "FJf00fas"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
$CLI_EXE \
    ...
    --namespace $AB_NAMESPACE \
    --emails '["oLu9bi1x", "Zb4k2s49", "Se2PsMH7"]' \
    > test.out 2>&1
