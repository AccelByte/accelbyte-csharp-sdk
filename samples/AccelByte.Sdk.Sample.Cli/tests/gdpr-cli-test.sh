...
# body param: body
echo '["QS8t1VJe", "XKsWnybL", "RPijwUXJ"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
# body param: body
echo '["BFAVZKDh", "1MIaJqy1", "C4cjWhIq"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
$CLI_EXE \
    ...
    --namespace $AB_NAMESPACE \
    --emails '["EQ2KXTOH", "TTNk5OTk", "M9kAMdwa"]' \
    > test.out 2>&1
