...
# body param: body
echo '["8mbLxB8v", "1TGIuKkZ", "0YebsmjL"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
# body param: body
echo '["QrwKOPjb", "kuWScJCw", "MTETW65M"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
$CLI_EXE \
    ...
    --namespace $AB_NAMESPACE \
    --emails '["hGZzHPAp", "ynIP7fG4", "V52yI257"]' \
    > test.out 2>&1
