...
# body param: body
echo '["kUwPOkPU", "Dr8nF324", "IDU5KzZd"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
# body param: body
echo '["t0hkIwVf", "OWDJ7hNg", "g6p8xwfS"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
$CLI_EXE \
    ...
    --namespace $AB_NAMESPACE \
    --emails '["R4BVaHPa", "MjN3vwtR", "qZD08x0r"]' \
    > test.out 2>&1
