...
# body param: body
echo '["tSsWccvx", "DI0IBJzf", "M4DWq7dp"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
# body param: body
echo '["7Wt0fxvX", "oSe5ArZ5", "5fc9gMZC"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
$CLI_EXE \
    ...
    --namespace $AB_NAMESPACE \
    --emails '["I4G84JtP", "SztLdC5o", "4jCJ3TmC"]' \
    > test.out 2>&1
