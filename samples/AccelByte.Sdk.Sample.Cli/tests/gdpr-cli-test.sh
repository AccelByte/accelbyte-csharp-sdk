...
# body param: body
echo '["cnejShWP", "a0ax6tir", "zbQV6jEL"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
# body param: body
echo '["qYyHjaTZ", "pbzWn7AO", "giO6oyfI"]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn gdpr \
...
$CLI_EXE \
    ...
    --namespace $AB_NAMESPACE \
    --emails '["NsqfkzmQ", "VVnV2HcZ", "bgJaPhyM"]' \
    > test.out 2>&1
