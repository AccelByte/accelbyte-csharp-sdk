...
# body param: body
echo '{"Downloads": [{"alloc_id": "PQYaDbOU", "namespace": "GfJ4BKha", "pod_name": "CLOwWJOW"}, {"alloc_id": "E3eGGqUr", "namespace": "5qa3HKor", "pod_name": "Urxg1eUH"}, {"alloc_id": "ovOaxD08", "namespace": "dq8VB96p", "pod_name": "pb2G58sB"}]}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn dslogmanager \
