...
# body param: body
echo '{"Downloads": [{"alloc_id": "IFs1y7KQ", "namespace": "TeYtSGhe", "pod_name": "sHbN9AcR"}, {"alloc_id": "MLCfHDyF", "namespace": "6bVrilNt", "pod_name": "5WifHqxx"}, {"alloc_id": "MheF4e4p", "namespace": "xuITuIWr", "pod_name": "nOuA25IR"}]}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn dslogmanager \
