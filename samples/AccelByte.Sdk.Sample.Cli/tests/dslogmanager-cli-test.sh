...
# body param: body
echo '{"Downloads": [{"alloc_id": "FlVCIvcv", "namespace": "2cTo1Cy0", "pod_name": "U65xhKJ3"}, {"alloc_id": "lZOip0UX", "namespace": "yCjRXp24", "pod_name": "ceeYBvPU"}, {"alloc_id": "TALLqb76", "namespace": "HVxHvumq", "pod_name": "ZOMkFWSg"}]}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn dslogmanager \
