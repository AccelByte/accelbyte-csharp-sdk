...
#- 6 CreatePolicy
# body param: body
echo '{"affectedClientIds": ["3fMI04rm", "3tTqlE9o", "2jUc9iav"], "affectedCountries": ["LDPD0Lfl", "e8ESU1MO", "8XnVaEyj"], "basePolicyName": "mifJDYa1", "description": "TJPUszmF", "namespace": "GEkJVvqD", "tags": ["GfGq1FNm", "SU3PDyIA", "RWvUvDPn"], "typeId": "KoECjGUg"}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
    --op CreatePolicy \
    --reqfile $TEMP_JSON_INPUT \
...
# body param: body
echo '{"affectedClientIds": ["G14ID5l5", "nckjlW6B", "wj6K2wEM"], "affectedCountries": ["ywsSSZTG", "lubsmhjX", "cScOUvrj"], "basePolicyName": "JBO7tbkT", "description": "GYKqRMST", "namespace": "isP0MrSd", "tags": ["dfkfyt09", "ro5fHdWq", "aFy0pJYC"]}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
...
# body param: body
echo '{"currentPublishedOnly": true, "userIds": ["vwPewrf1", "ajwHO3Lf", "9Njm50xC"]}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
...
#- 20 CreatePolicy1
# body param: body
echo '{"affectedClientIds": ["dq0m7NjU", "jxyw7RHl", "T2x6o28N"], "affectedCountries": ["BN9YGVPt", "Z95Z5XDL", "kjt0OyBl"], "basePolicyName": "Ji4RbZ0I", "description": "y11mfOFj", "tags": ["FDtXnXLv", "CzZVcGom", "WF1oAqUN"], "typeId": "OAsW8wYh"}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
    --op CreatePolicy1 \
    --namespace $AB_NAMESPACE \
...
# body param: body
echo '{"affectedClientIds": ["u9b9Qjhz", "VLJiDx3a", "DlnJmi4X"], "affectedCountries": ["aBTgoXjf", "spSqwdbT", "dUQHa3Rx"], "basePolicyName": "R2sgzfaQ", "description": "rUCW9fgo", "tags": ["x8DmbC9U", "69uv1bkF", "qYdYrdxN"]}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
    --op PartialUpdatePolicy1 \
    --basePolicyId 'nuMcAwrS' \
    --namespace $AB_NAMESPACE \
    --reqfile $TEMP_JSON_INPUT \
    > test.out 2>&1
...
$CLI_EXE \
    ...
    --basePolicyId 'zYnrcetx' \
    --countryCode 'ObeisZel' \
    --namespace $AB_NAMESPACE \
    > test.out 2>&1
...
$CLI_EXE \
    ...
    --namespace $AB_NAMESPACE \
    --policyVersionId 'KuD0iJ6f' \
    > test.out 2>&1
eval_tap $? 24 'RetrieveLocalizedPolicyVersions1' test.out

#- 25 CreateLocalizedPolicyVersion1
# body param: body
echo '{"contentType": "s3zL9H4W", "description": "xGWRH7fz", "localeCode": "4BdPhLtH"}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
    --op CreateLocalizedPolicyVersion1 \
    --namespace $AB_NAMESPACE \
    --policyVersionId 'RJOImSq3' \
    --reqfile $TEMP_JSON_INPUT \
    > test.out 2>&1
...
$CLI_EXE \
    ...
    --localizedPolicyVersionId '7aeAaGq0' \
    --namespace $AB_NAMESPACE \
    > test.out 2>&1
...
# body param: body
echo '{"attachmentChecksum": "NIj53gXk", "attachmentLocation": "mrayvcIY", "attachmentVersionIdentifier": "iWxIAxfv", "contentType": "LzSpDFY3", "description": "lxe16KsS"}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
    --op UpdateLocalizedPolicyVersion1 \
    --localizedPolicyVersionId 'Rzkf2HzB' \
    --namespace $AB_NAMESPACE \
    --reqfile $TEMP_JSON_INPUT \
    > test.out 2>&1
...
# body param: body
echo '{"contentMD5": "cEio5Uyv", "contentType": "uFv5z6wo"}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
    --op RequestPresignedURL1 \
    --localizedPolicyVersionId 'sJGnUyCM' \
    --namespace $AB_NAMESPACE \
    --reqfile $TEMP_JSON_INPUT \
    > test.out 2>&1
...
$CLI_EXE \
    ...
    --localizedPolicyVersionId 'EbHh1uE4' \
    --namespace $AB_NAMESPACE \
    > test.out 2>&1
...
# body param: body
echo '{"description": "DmJ4Suj6", "displayVersion": "DjUw36Gt", "isCommitted": false}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
