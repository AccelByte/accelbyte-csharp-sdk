...
# body param: body
echo '{"affectedClientIds": ["icGQAVv32ftRAsmC", "cQmnsUigVynjGFyV", "Bam8jPtKHTmzo0Jm"], "affectedCountries": ["0RuRA8j1AJ3hNWWh", "ADRqJvaZrf2qXQFC", "zRV1paELj5dw3LK0"], "basePolicyName": "gPYhPPG5sAIfYtYo", "description": "zA2OntGCwQSHHdPL", "tags": ["pVpxdUWOPel3TiwT", "BhRAYjR7c4x5bIk8", "wjTngrvb2E1X9ecB"]}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
