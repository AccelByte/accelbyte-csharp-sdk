...
# body param: body
echo '{"clientId": "bBuz5zko", "eventName": "aUEzGS3q", "payloadQuery": {"Zf0PbemS": {}, "BELbZ0VB": {}, "UGA7nkDe": {}}, "sessionId": "ev2Oj060", "traceId": "HnOf5S8X", "userId": "1LxkZs42", "version": 36}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
