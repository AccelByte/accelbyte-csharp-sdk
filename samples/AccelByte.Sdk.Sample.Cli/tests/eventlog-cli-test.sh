...
# body param: body
echo '{"clientId": "WEKVRmaP", "eventName": "OPz8X5TU", "payloadQuery": {"wHcVrI4a": {}, "JUs3MWzx": {}, "Tv1Crssg": {}}, "sessionId": "pXUA7Wuu", "traceId": "h9RFD6DL", "userId": "S9Y5Leab", "version": 79}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
