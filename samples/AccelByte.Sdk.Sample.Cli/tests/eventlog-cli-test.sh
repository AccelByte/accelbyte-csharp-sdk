...
# body param: body
echo '{"clientId": "2O0q5FtJ", "eventName": "vHBGrLOE", "payloadQuery": {"ScDj6i9p": {}, "ZIOSkn1O": {}, "Kq1MacBN": {}}, "sessionId": "GWwJQAB2", "traceId": "DzFQn9WK", "userId": "CS4pngOD", "version": 46}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
