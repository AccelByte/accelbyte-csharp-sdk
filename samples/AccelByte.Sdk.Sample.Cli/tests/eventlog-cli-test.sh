...
# body param: body
echo '{"clientId": "Dk22aJmI", "eventName": "R0mP9b6u", "payloadQuery": {"DVlQFl6A": {}, "hXw4C9Ls": {}, "r3jxH40B": {}}, "sessionId": "OMYLIJlQ", "traceId": "aaiFWhpw", "userId": "GGHyvi2Z", "version": 69}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
