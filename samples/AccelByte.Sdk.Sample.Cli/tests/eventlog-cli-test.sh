...
# body param: body
echo '{"clientId": "0wTB1KvH", "eventName": "xBUCUFDP", "payloadQuery": {"8uvjYCDA": {}, "7bTZfHwj": {}, "jgyhI8hU": {}}, "sessionId": "bNyhiD29", "traceId": "o6HkjCd3", "userId": "aV4gTGPH", "version": 52}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
