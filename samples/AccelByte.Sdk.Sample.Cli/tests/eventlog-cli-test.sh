...
# body param: body
echo '{"clientId": "pkQJMQ72", "eventName": "Mm9Gwv3u", "payloadQuery": {"XUo6kGLV": {}, "5JXv0A9C": {}, "MeRhGlck": {}}, "sessionId": "Y6wtOYfP", "traceId": "egBratxu", "userId": "qfzNS8YZ", "version": 76}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
