...
# body param: body
echo '{"clientId": "Qski4mQV", "eventName": "pTBfi0o2", "payloadQuery": {"07syaVkI": {}, "prbmtowE": {}, "LfUKoLLI": {}}, "sessionId": "31itfho5", "traceId": "gQI3xVH6", "userId": "lBvMjhqJ", "version": 61}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
