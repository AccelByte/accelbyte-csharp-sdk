...
# body param: body
echo '{"clientId": "10m17rRD", "eventName": "iBY7hc9P", "payloadQuery": {"MTZmUINH": {}, "2DnlRwUv": {}, "br604cMy": {}}, "sessionId": "IxdRLAKN", "traceId": "Kbr9ZAf8", "userId": "RExKAyOb", "version": 18}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
