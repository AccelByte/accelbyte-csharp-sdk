...
# body param: body
echo '{"clientId": "9azy3NVL", "eventName": "JtzJuRsj", "payloadQuery": {"Q1Uz3M2B": {}, "v4MRV91d": {}, "Cl8DM2Fh": {}}, "sessionId": "iLJ4EbvB", "traceId": "xpghr82k", "userId": "j8OkNUJc", "version": 95}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
