...
# body param: body
echo '{"clientId": "LlXhZauw", "eventName": "1Ka6HrNu", "payloadQuery": {"LAZOVTCb": {}, "EkaVqABZ": {}, "QhuJU6J0": {}}, "sessionId": "hWFyZPBE", "traceId": "F9b4PuoC", "userId": "aCN0Hcpk", "version": 94}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
