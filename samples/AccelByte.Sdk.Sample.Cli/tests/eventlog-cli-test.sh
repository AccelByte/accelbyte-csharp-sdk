...
# body param: body
echo '{"clientId": "aSk5yVHJ", "eventName": "zIMoDdO9", "payloadQuery": {"55ZwL0WL": {}, "nl3SnaRQ": {}, "uU94jxEQ": {}}, "sessionId": "r9FQnr3D", "traceId": "MNrZOtM4", "userId": "FnT0sQ1g", "version": 100}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
