...
# body param: body
echo '{"clientId": "If3wp6e6", "eventName": "HwcSw3HO", "payloadQuery": {"tZrbQMGK": {}, "EoPIWcdr": {}, "QsdlQhw9": {}}, "sessionId": "UtBrNmMC", "traceId": "2HiKH5aO", "userId": "fDxOnyf6", "version": 49}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
