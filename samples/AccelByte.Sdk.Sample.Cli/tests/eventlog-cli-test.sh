...
# body param: body
echo '{"clientId": "EVhF9N8r", "eventName": "G06Z9Dpp", "payloadQuery": {"LM79Ny9P": {}, "xBQT7Nxj": {}, "0fQjqKu3": {}}, "sessionId": "djrBCHYc", "traceId": "61mEqjrx", "userId": "MjFFOP91", "version": 15}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
