...
# body param: body
echo '{"clientId": "YWchGaS6", "eventName": "iaWaSZD3", "payloadQuery": {"YfA4hfAg": {}, "XNaq5eN8": {}, "ZDSpXOPI": {}}, "sessionId": "RswsfPEg", "traceId": "mToyqKPj", "userId": "vHAeJ5gY", "version": 64}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
