...
# body param: body
echo '{"clientId": "6wYwDjRI", "eventName": "VvvHxMmb", "payloadQuery": {"ztHXUBVt": {}, "M1c8wnkL": {}, "PCBNry0u": {}}, "sessionId": "0jsJkAVa", "traceId": "gmJRBDI1", "userId": "RAbE1Xrc", "version": 0}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
