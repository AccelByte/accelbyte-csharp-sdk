...
# body param: body
echo '{"clientId": "DHfTxRrO", "eventName": "AWiCFkEK", "payloadQuery": {"wrITmFxt": {}, "Q9vUV4Je": {}, "VsfiamEN": {}}, "sessionId": "ZqZgIuMz", "traceId": "SAIF8Xvc", "userId": "Ws6SLpT2", "version": 35}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
