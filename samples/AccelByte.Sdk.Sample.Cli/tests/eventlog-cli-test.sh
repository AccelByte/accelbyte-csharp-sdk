...
# body param: body
echo '{"clientId": "romrzbyF", "eventName": "aTeUl2nx", "payloadQuery": {"Ym5IN6ON": {}, "WhndUNKk": {}, "RcBkRjOn": {}}, "sessionId": "lProltJ8", "traceId": "scG7mv5o", "userId": "51E5F5m9", "version": 68}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
