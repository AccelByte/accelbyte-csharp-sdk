...
# body param: body
echo '{"clientId": "SfOZ6JiC", "eventName": "arrQS1wa", "payloadQuery": {"PIji4ELl": {}, "163cuoMY": {}, "JRbpkMhP": {}}, "sessionId": "wHxoSj4l", "traceId": "lLRDHBnQ", "userId": "aKMrthgv", "version": 46}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
