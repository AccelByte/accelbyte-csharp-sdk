...
# body param: body
echo '{"clientId": "tBXVn0lH", "eventName": "zKdmj7rC", "payloadQuery": {"f5J2aFWj": {}, "rfJbe1uB": {}, "dXdzLhH0": {}}, "sessionId": "IFAERPDR", "traceId": "Pkqj2aZm", "userId": "ehQn2Vhy", "version": 12}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
